...
// @ts-ignore
import stackRendererVertex from './shaders/geometry-renderer-flat.glsl.vert';
// @ts-ignore
import stackRendererFragment from './shaders/geometry-renderer-flat.glsl.frag';

import * as glm from 'gl-matrix';

const k_bufferSize = 14 * 1024;

export interface IFlatVertex {
  pos: glm.vec3;
  // normal: glm.vec3;
}

export interface IGeometryRendererFlat {
  push(
...
export class GeometryRendererFlat implements IGeometryRendererFlat {
  ...
  constructor() {
    this._shader = new webgl2.ShaderProgram('GeometryRendererFlat', {
  ...
  setGeometryVertices(vertices: IFlatVertex[]) {
